	...
	<div class="row">
      ...
      <h4 class="footer-heading">We're Social</h4>
			<ul class="social-links">
				<li>
					<a href="https://twitter.com/xdadevelopers" target="_blank" title="XDA Developers on Twitter">
				...
				<li>
					<a href="https://www.youtube.com/user/xdadevelopers?sub_confirmation=1" target="_blank" title="XDA Developers on YouTube">
